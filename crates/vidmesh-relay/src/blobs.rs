...
/// The single call site into `vidmesh_kernel::ChunkTree` (spec 001 §8).
...
fn compute_chunk_proof(
    ...
    use vidmesh_kernel::blob::CHUNK_SIZE;
    use vidmesh_kernel::ChunkTree;
...
mod tests {
    ...
    async fn put_then_read_back_matches_and_hash_is_derived_not_trusted() {
        ...
        let payload = b"hello vidmesh blob".to_vec();
